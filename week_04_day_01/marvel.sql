...
-- UPDATE movies SET show_time = '16:25' WHERE show_time = '19:15';
--
SELECT * FROM people;

-- DELETE FROM people WHERE name = 'Donald Trump';
-- SELECT people.name FROM people;
-- UPDATE people SET name = 'Rose Ulldemolins' WHERE name = 'Ros Ulldemolins';
-- SELECT people.name FROM people;

-- SELECT people.name  FROM people WHERE id = 6;
